...
<body>
    ...
    <main>
        ...
        <br>
        <p>
            From here you can easily insert items information, edit items information, generate report
            , and delete item.
        </p>
        <div class="call-to-action">
            <a href="//127.0.0.1/Supplier/GemerateReport">Generate Report Now</a>
        </div>
    </main>
    <footer>
